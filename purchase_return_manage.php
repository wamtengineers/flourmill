...
if(isset($_GET["status"])){
	...
	$_SESSION["purchase_return"]["list"]["status"]=$status;
}
if(isset($_SESSION["purchase_return"]["list"]["status"])){
	$status=$_SESSION["purchase_return"]["list"]["status"];
}
else{
	$status=1;
}	
...
<?php
$manage_url = 'purchase_return_manage.php';
?>
