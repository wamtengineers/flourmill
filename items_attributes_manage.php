...
define("APP_START", 1);
$filename = 'items_attributes_manage.php';
if(isset($_GET["parent_id"])){
	$_SESSION["items_attributes"]["item_id"]=$_GET["parent_id"];
}
if( isset( $_SESSION["items_attributes"]["item_id"] ) ) {
	$parent_item_id = $_SESSION["items_attributes"]["item_id"];
}
else {
	die( 'Select Parent Item Attributes' );
}
...
switch($tab){
	case 'add':
		include("modules/items_attributes/add_do.php");
	break;
	case 'edit':
		include("modules/items_attributes/edit_do.php");
	break;
	case 'delete':
		include("modules/items_attributes/delete_do.php");
	break;
	case 'bulk_action':
		include("modules/items_attributes/bulkactions.php");
	break;
}
?>
            ...
            <div class="container-widget row">
                <div class="col-md-12">
                  <?php
                    switch($tab){
                        case 'list':
                            include("modules/items_attributes/list.php");
                        break;
                        case 'add':
                            include("modules/items_attributes/add.php");
                        break;
                        case 'edit':
                            include("modules/items_attributes/edit.php");
                        break;
                    }
                  ?>
                </div>
