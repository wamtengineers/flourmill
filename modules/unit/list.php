...
if(isset($_GET["q"])){
	$q=slash($_GET["q"]);
	$_SESSION["unit"]["list"]["q"]=$q;
}
if(isset($_SESSION["unit"]["list"]["q"]))
	$q=$_SESSION["unit"]["list"]["q"];
else
	$q="";
if(!empty($q)){
	...
	<h1 class="title">Manage Unit</h1>
  	...
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="unit_manage.php?tab=add" class="btn btn-light editproject">Add New Record</a> 
...
<div class="panel-body table-responsive">
	<table class="table table-hover list">
    	...
    	<tbody>
			<?php 
            $sql="select * from unit where 1 $extra order by id";
            ...
            if(numrows($rs)>0){
                ...
                <tr>
                    ...
                    <td colspan="2" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "unit", $sql, $pageNum)?></td>
                </tr>
                <?php	
            }
            else{	
