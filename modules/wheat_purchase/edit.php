...
<div class="page-header">
	<h1 class="title">Edit Wheat Purchase</h1>
  	<ol class="breadcrumb">
    	<li class="active">Manage Wheat Purchasee</li>
  	</ol>
  	<div class="right">
...
<form class="form-horizontal form-horizontal-left" role="form" action="wheat_purchase_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd">
    ...
    <div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="Update" class="btn btn-default btn-l" name="wheat_purchase_edit" title="Update Record" />
            </div>
        </div>
  	</div>
</form>