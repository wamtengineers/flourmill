...
if(isset($_GET["action"]) && $_GET["action"]!=""){
	...
	if(empty($err)){
		...
		if($bulk_action=="statuson"){
			...
			header("Location: purchase_return_manage.php?tab=list&msg=".url_encode("Records Status Dispatched."));
			die;
		}
		if($bulk_action=="statusof"){
			...
			header("Location: purchase_return_manage.php?tab=list&msg=".url_encode("Records Status Cancelled."));
			die;
		}
		if($bulk_action=="statusrec"){
			...
			header("Location: purchase_return_manage.php?tab=list&msg=".url_encode("Records Status Delivering."));
			die;
		}
	}
	else{
