...
<div class="page-header">
	<h1 class="title">Edit Purchase Return</h1>
  	<ol class="breadcrumb">
...
<form action="purchase_return_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();" class="form-horizontal form-horizontal-left">
    ...
    <div class="form-group">
  	...
  	<div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="UPDATE" class="btn btn-default btn-l" name="purchase_return_edit" title="Submit Record" />
            </div>
        </div>
  	</div>
</form>