...
<div class="page-header">
	<h1 class="title">Manage Purchase Return</h1>
  	<ol class="breadcrumb">
    	<li class="active">Purchase Return and billing</li>
  	</ol>
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="purchase_return_manage.php?tab=addedit" class="btn btn-light editproject">Add New Record</a> 
            <a id="topstats" class="btn btn-light" href="#"><i class="fa fa-search"></i></a> 
            <a class="btn print-btn" href="purchase_return_manage.php?tab=report"><i class="fa fa-print" aria-hidden="true"></i></a>  
        </div>
  	</div>
</div>
	...
	<table class="table table-hover list">
    	<thead>
            <tr>
                ...
                <th>
                	<a href="purchase_return_manage.php?order_by=datetime_added&order=<?php echo $order=="asc"?"desc":"asc"?>" class="sorting">
                        Date
                        <?php
                ...
                <th class="text-right">
                	<a href="purchase_return_manage.php?order_by=total_price&order=<?php echo $order=="asc"?"desc":"asc"?>" class="sorting">
                		Total Price
                        <?php
            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="purchase_return_manage.php?tab=addedit&id=<?php echo $r['id'];?>"><img title="Edit Record" alt="Edit" src="images/edit.png"></a>&nbsp;&nbsp;
                            <a href="purchase_return_manage.php?tab=print&id=<?php echo $r['id'];?>"><img title="Print Record" alt="Print" src="images/view.png"></a>&nbsp;&nbsp;
                            <a onclick="return confirm('Are you sure you want to delete')" href="purchase_return_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete"><img title="Delete Record" alt="Delete" src="images/delete.png"></a>
                        </td>
                    </tr>
                    <?php 
                    $sn++;
                ...
                <tr>
                    ...
                    <td colspan="5" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "purchase_return", $sql, $pageNum)?></td>
                </tr>
                <?php	
            }
            else{	
