	...
	<h1 class="title">Manage Customer Payment</h1>
  	...
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="customer_payment_manage.php?tab=add" class="btn btn-light editproject">Add New Customer Payment</a> <a id="topstats" class="btn btn-light" href="#"><i class="fa fa-search"></i></a>
	...
	<table class="table table-hover list">
    	<thead>
            <tr>
                ...
                <th width="10%">
                	<a href="customer_payment_manage.php?tab=list&order_by=datetime_added&order=<?php echo $order=="asc"?"desc":"asc"?>" class="sorting">
                		Datetime
                        <?php
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="customer_payment_manage.php?tab=print_receipt&id=<?php echo $r['id'];?>"><img title="Edit Record" alt="Edit" src="images/view.png"></a>&nbsp;&nbsp;
