...
<div ng-app="sales" ng-controller="salesController" id="salesController">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-sm-10">
                <select class="margin-btm-5" ng-model="sales.customer_id" chosen>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-sm-10">
            	<input ng-model="sales.less_weight" class="form-control" />
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-hover list">
                        ...
                        <tbody>
                            <tr ng-repeat="item in sales.items">
                                ...
                                <td>
                                    <select title="Choose Option" ng-change="update_price( $index )" ng-model="sales.items[$index].item_id" chosen>
                                        <option value="">Select Items</option>
                                        <option ng-repeat="item in items" value="{{ item.id }}">{{ item.category }} - {{ item.title }}</option>
                                    </select>
                                </td>
                                <td class="text-right"><input type="text" ng-change="update_total( $index )" ng-model="sales.items[$index].packing" /></td>
                                <td class="text-right"><input type="text" ng-change="update_total( $index )" ng-model="sales.items[$index].unit_price" /></td>
                            ...
                            <tr>
                                ...
                                <th class="text-right">{{ grand_total()-sales.discount|currency:'':0 }}</th>
                                <th class="text-right">&nbsp;</th>
                            </tr>
                            <tr>
                                <th class="text-right" colspan="5"><label>Payment Account </label></th>
                                <th class="text-right" colspan="2">
                                    <select class="margin-btm-5" ng-model="sales.payment_account_id" chosen>
