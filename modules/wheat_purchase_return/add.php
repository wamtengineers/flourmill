...
if(isset($_SESSION["wheat_purchase_return_manage"]["add"])){
	extract($_SESSION["wheat_purchase_return_manage"]["add"]);	
}
else{
...
<div class="page-header">
	<h1 class="title">Add New Wheat Purchase Return</h1>
  	<ol class="breadcrumb">
...
<form class="form-horizontal form-horizontal-left" role="form" action="wheat_purchase_return_manage.php?tab=add" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();">
    <?php
        $i=0;
    ?>
    ...
    <div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="SUBMIT" class="btn btn-default btn-l" name="wheat_purchase_return_add" title="Submit Record" />
            </div>
        </div>
  	</div>  
</form>