...
<div class="page-header">
	<h1 class="title">Edit Account Type</h1>
  	<ol class="breadcrumb">
...
<form action="account_type_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd"  class="form-horizontal form-horizontal-left">
    ...
    <div class="form-group">
  	...
  	<div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="UPDATE" class="btn btn-default btn-l" name="account_type_edit" title="Update Record" />
            </div>
        </div>
  	</div>
</form>